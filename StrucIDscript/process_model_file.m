function [algebraicEqns,algebraicEqnsTxt,ODEs,ODEsTxt,ICStateEqns,ICStateEqnsTxt,icNames,stateNames,stateValues,...
    parNames,parValues,ParIndex,inputNames,inputEqns,inputEqnsTxt,outputNames,outputEqns,...
    outputEqnsTxt] = process_model_file(tree)
...
algebraicEqnsTxt=algebraicEqns;
...
for j=1:nx
    ...
    icNames{j}=[stateNames{j},'(0)'];
    ICStateEqns{j}=icNames{j};
...
parAnalysed=parAnalysed(~cellfun('isempty',parAnalysed)); % remove empty cells if needed
